...
public class GameOver2 : MonoBehaviour
{
    ...
    // через такие методы предполагал что буду дергать ивенты в других классах
    // (в классе рика проверка здоровье если < 0 то дернуть его смерть)
    // осталось придумать как сетапить поведение ивента
